...
if (flag==0) {Console.WriteLine("Число палиндром");}
...
Console.Write($"Расстояние между точками А({mas[0,0]}, {mas[0,1]}, {mas[0,2]}) и В ({mas[1,0]}, {mas[1,1]}, {mas[1,2]}) составляет {masR:f2}");
